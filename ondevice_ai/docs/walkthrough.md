...
2. **TFLite 모델 추론 층 (`src/inference/`)**:
...
4. **통합 실행 노드 (`src/integrated_node/`)**:
...
- [`../operations/HARDWARE_RUNBOOK.md`](../operations/HARDWARE_RUNBOOK.md): 하드웨어 설치·운용 절차
- [`../architecture/BRANCH_PROVENANCE.md`](../architecture/BRANCH_PROVENANCE.md): 원본 브랜치와 이동 이력
