...
REQUIRED = (
    ...
    "RaspberryPi/Runtime/ai/co2_canonical_runtime.py",
    "RaspberryPi/Runtime/ai/mmwave_canonical_runtime.py",
    "RaspberryPi/Runtime/ai/mmwave_spectral_runtime.py",
    "RaspberryPi/Runtime/risk/formula_v1.py",
    "RaspberryPi/Runtime/risk/risk_formula_v1.json",
    ...
    "RaspberryPi/Ondevice_AI/scripts/mmwave_m_n4_canonical.py",
